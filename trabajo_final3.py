...
archivo = open("data_genes.txt", "r")  # Levantar la base
print(archivo.readlines())
archivo.seek(0)  # Ordena en columnas
for x in archivo:
    print(x, end="")
archivo.close()
...
# Estructura for in para busqueda

"""
ESTA ES LA FUNCIÓN EN LA QUE QUEDAMOS TRABAJANDO
def fbusqueda():
    for x in archivo[]:
        if x == Nombre1:
